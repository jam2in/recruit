...
> - ARCUS Server를 다양한 응용들에서 유용하게 사용할 수 있도록 필요한 데이터 모델이나 기능, 기술을 개발합니다.
> - ARCUS Server의 문제점이나 최적화할 요인들을 찾아 개선하여 시스템 완성도를 높여나갑니다.
...
> - 전반적인 Computer Science 이해와 관련 아이디어 구현 경험
...
> - 4대 보험(국민연금, 의료보험, 고용보험, 산재보험), 퇴직연금, 청년내일채움공제
